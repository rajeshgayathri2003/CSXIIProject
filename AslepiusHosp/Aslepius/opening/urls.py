...
from . import views
from contactus.views import contactthankyou
...
urlpatterns = [path('',views.FrontScreen,name='FrontScreen'),
               ...
               path('ortho', deptviews.orthopaedics, name='ortho'),
               path('psy', deptviews.psychiatry, name='psy'),
               path('pulmo', deptviews.pulmonology, name='pulmo'),
               ...
               path('contactthankyou',contactthankyou, name='contactthankyou')
